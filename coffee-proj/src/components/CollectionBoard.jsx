...
const CollectionBoard = () => {
    ...
    return (
        <div className='bg-[#111315] w-[80%] lg:h-[1050px] absolute top-[200px] rounded-xl flex flex-col items-center justify-start '>
            ...
            <div className='w-[80%] lg:mt-[10px] md:mt-[20px] sm:mt-[50px] grid justify-items-center lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-4'>
                {coffeeData && coffeeData.length > 0 ? (
                    coffeeData.map((coffee) => (
                        <div key={coffee.id} className='w-[280px] h-[250px] text-[#FEF7EE] relative mb-[50px]'>
                            {coffee.popular && (
